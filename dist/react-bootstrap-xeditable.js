...
var EditableSelect = function (_React$Component) {
  ...
  function EditableSelect(props) {
    ...
    _this.state = {
      isEditing: _this.props.isEditing ? true : false,
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.options || nextProps.value) {
        ...
        if (nextProps.value !== this.state.value) {
          var selected = newState.options && newState.options.find(function (opt) {
    ...
    value: function render() {
      if (this.state.isEditing) {
        ...
        return _react2.default.createElement(
          _XEditable2.default,
          { isLoading: false, save: this.save, cancel: this.cancel },
          _react2.default.createElement('input', { ref: 'el', id: this.props.id, type: 'text', className: inputClassName, name: this.props.name, defaultValue: this.props.value, placeholder: this.props.placeholder, autoFocus: true }),
